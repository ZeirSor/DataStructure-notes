...
- [图](#图)
	...
	- [图的存储结构](#图的存储结构)
		- [邻接矩阵存储 **Adjacency Matrix**](#邻接矩阵存储-adjacency-matrix)
			- [邻接矩阵的存储代码](#邻接矩阵的存储代码)
			- [基于邻接矩阵——创建函数](#基于邻接矩阵创建函数)
				...
				- [无向网](#无向网)
				- [有向网](#有向网)
		- [邻接表存储 **Adjacencyc List**](#邻接表存储-adjacencyc-list)
			- [邻接表存储代码](#邻接表存储代码)
		...
		- [邻接多重表](#邻接多重表)
		- [边集数组](#边集数组)
	- [图的遍历 Traversing Graph](#图的遍历-traversing-graph)
	...
	- [最小生成树 Minimum Cost Spanning Tree](#最小生成树-minimum-cost-spanning-tree)
		- [普里姆算法 Prim's Algorithm](#普里姆算法-prims-algorithm)
		- [克鲁斯卡尔算法 Kruskal's Algorithm](#克鲁斯卡尔算法-kruskals-algorithm)
	- [最短路径](#最短路径)
		- [迪杰斯特拉算法 Dijkstra's Algorithm](#迪杰斯特拉算法-dijkstras-algorithm)
		- [弗洛伊德算法 Floyd–Warshall Algorithm](#弗洛伊德算法-floydwarshall-algorithm)
	- [拓扑排序](#拓扑排序)
		- [基本概念](#基本概念)
...
- [查找](#查找)
	- [基本概念](#基本概念-2)
		- [查找表 Search Table](#查找表-search-table)
		- [关键字 Key](#关键字-key)
		- [次关键字 Secondary Key](#次关键字-secondary-key)
		- [静态查找表 Static Search Table](#静态查找表-static-search-table)
		- [动态查找表 Dynamic Search Table](#动态查找表-dynamic-search-table)
		- [平均查找长度ASL](#平均查找长度asl)
	- [顺序表查找](#顺序表查找)
		- [普通法](#普通法)
		- [优化法(设置哨兵)sentry](#优化法设置哨兵sentry)
	- [有序表查找](#有序表查找)
		- [折半查找(二分查找)](#折半查找二分查找)
		- [插值查找](#插值查找)
		- [斐波那契查找](#斐波那契查找)
	- [索引查找](#索引查找)
		...
		- [分块索引](#分块索引)
		- [倒排索引](#倒排索引)
	- [二叉排序树 BST(Binary Sort Tree)](#二叉排序树-bstbinary-sort-tree)
	- [平衡二叉树 ALV树](#平衡二叉树-alv树)
